...
\begin{poster}
    ...
    \block{l}{Hong-Ou-Mandel interference and indistinguishability}{
        ...
        When two indistinguishable photons enter the input ports of a 50:50 beam splitter, HOM interference manifests in the suppression of the measured coincidence events. High visibility of this interference depends on achieving high indistinguishability in all internal degrees of freedom, including relative delay (see figure below), polarisation, and frequency.\\[0.25cm]
        \raisebox{4ex}{
    ...
    \block{r}{Domain engineering}{
        ...
        Engineering the domain poling to track the field allows achieving a Gaussian PMF and suppressing correlations.\\[0.3cm]
        \raisebox{0ex}{
    ...
    \block{l}{Pump spectral shaping}{
        \begin{center}
            \includegraphics[width=.9\textwidth]{pics/PulseShaper_breadboard.png}
        \end{center}
    }
    ...
    {\centering
    \includegraphics[width=0.96\textwidth]{pics/Setup_PureSources_v3.png}}\\[0.25cm]
    ...
    % JSA measurement
    \includegraphics[width=0.37\textwidth]{pics/Purity99.82_normJSA.png}
    $\qquad \qquad$
    % HOM measurement
